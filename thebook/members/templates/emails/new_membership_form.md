...
Para oficializar a sua associação ao **Laboratório Hacker de Campinas** precisamos de algumas informações sobre você.
...
Você tem até o dia {{ membership_form.valid_until }} para preencher este formulário.
